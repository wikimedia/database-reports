...
from displayTable import display_report
...
class Reports:
    ...
    def forgotten_articles(self):
        ...
        content.append(
            [
                "forgotten-articles-title",
                "forgotten-articles-last-edited",
                "forgotten-articles-editcount",
            ]
        )
    ...
    def page_count_by_namespace(self):
        ...
        content.append(
            [
                "pagecount-namespace",
                "pagecount-namespace-name",
                "pagecount-total",
                "pagecount-redirect",
                "pagecount-non-redirect",
            ]
        )
        for row in self.query(query):
            content.append(
    ...
    def autopatrol_eligibles(self):
        ...
        content = []
        content.append(
            ["autopatrol-username", "autopatrol-listlink", "autopatrol-articles"]
        )
        for row in self.query(query):
            if row[1] is None:
                continue
    ...
    def oldest_active(self):
        ...
        content.append(
            [
                "oldestactive-username",
                "oldestactive-creationdate",
                "oldestactive-editcount",
            ]
        )
        for row in self.query(query):
            content.append([row[0], row[1], row[2]])
    ...
    def orphaned_talk(self):
        ...
        content.append(
            [
                "orphantalk-count",
                "orphantalk-isredirect",
                "orphantalk-namespace",
                "orphantalk-itemtitle",
                "orphantalk-pagesize",
            ]
        )
        namespace_translate = {
    ...
    def most_edited_page_last_month(self):
        ...
        content.append(
            [
                "most_edited_page_last_month-title",
                "most_edited_page_last_month-editcount",
            ]
        )
        for row in self.query(query):
    ...
    def article_by_size(self):
        ...
        content.append(
            [
                "article_by_size-namespace",
                "article_by_size-title",
                "article_by_size-size",
            ]
        )
        for row in self.query(query):
            content.append([row[0], self.linkify(row[1], row[0]), row[2]])
